...
public class SecureMessaging {
    ...
    func protect(apdu : APDUCommand, useExtendedMode: Bool = false ) throws -> APDUCommand {
...
//        let newAPDU = NFCISO7816APDU(data:Data(protectedAPDU))!
        return APDUCommand(bytes: protectedAPDU)!
    }
    ...
    func maskClassAndPad(apdu : APDUCommand ) -> [UInt8] {
    ...
    func buildD087(apdu : APDUCommand) throws -> [UInt8] {
    ...
    func padAndEncryptData(_ apdu : APDUCommand) -> [UInt8] {
    ...
    func buildD097(apdu : APDUCommand) throws -> [UInt8] {
