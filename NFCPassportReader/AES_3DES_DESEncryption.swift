...
public func AESEncrypt(key:[UInt8], message:[UInt8], iv:[UInt8]) -> [UInt8] {
    ...
    if cryptStatus == kCCSuccess {
        ...
        AppLogger.passportReader.error("AES Encrypt Error: \(cryptStatus)")
    }
    return []
}
...
public func AESDecrypt(key:[UInt8], message:[UInt8], iv:[UInt8]) -> [UInt8] {
    ...
    if cryptStatus == kCCSuccess {
        ...
        AppLogger.passportReader.error("AES Decrypt Error: \(cryptStatus)")
    }
    return []
}
...
public func AESECBEncrypt(key:[UInt8], message:[UInt8]) -> [UInt8] {
    ...
    if cryptStatus == kCCSuccess {
        ...
        AppLogger.passportReader.error("AESECBEncrypt Error: \(cryptStatus)")
    }
    return []
}
...
public func tripleDESEncrypt(key:[UInt8], message:[UInt8], iv:[UInt8]) -> [UInt8] {
    ...
    if cryptStatus == kCCSuccess {
        ...
        AppLogger.passportReader.error("Error: \(cryptStatus)")
    }
    return []
}
