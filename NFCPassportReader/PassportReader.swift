...
public class PassportReader : NSObject {
    ...
    public var passport : NFCPassportModel = NFCPassportModel()
    
    private var readerSession: NFCTagReaderSession?
    private var currentlyReadingDataGroup : DataGroupId?
    
    public var dataGroupsToRead : [DataGroupId] = []
    public var readAllDatagroups = false
...
//        _ = try await tagReader.selectPassportApplication() // ==> New
