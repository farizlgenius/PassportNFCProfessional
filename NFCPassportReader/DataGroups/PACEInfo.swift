...
public class PACEInfo : SecurityInfo {
    ...
    public func createMappingKey( ) throws -> OpaquePointer {
        ...
        switch try getKeyAgreementAlgorithm() {
            case "DH":
                AppLogger.pace.debug( "Generating DH mapping keys")
                ...
                switch try getParameterSpec() {
                    case 0:
                        AppLogger.pace.debug( "Using DH_get_1024_160" )
                        dhKey = DH_get_1024_160()
                    case 1:
                        AppLogger.pace.debug( "Using DH_get_2048_224" )
                        dhKey = DH_get_2048_224()
                    case 2:
                        AppLogger.pace.debug( "Using DH_get_2048_256" )
            ...
            case "ECDH":
                ...
                AppLogger.pace.debug( "Generating ECDH mapping keys from parameterSpec - \(parameterSpec)")
